...
env_data <- GIFT_env(
	...
	GIFT_version = "latest",
	api = "https://gift.uni-goettingen.de/api/extended/")
View(env_data)#geo_entity and biome for each
...
clim_biom <- merge(biomes_data, clim_data[-c(2)], by = "entity_ID")
View(clim_biom)#mean temperature, mean annual precipitation, geographic coordinates, biomes, botanical country and so on variables
